#!/usr/bin/env python3
"""
Reads results.csv (produced by run_benchmarks.py) and plots raw Execution
Time vs. number of processing elements for pure MPI, pure multithreading,
and hybrid configurations, with the sequential baseline as a reference
line. Saves execution_time.png.
"""
import csv
...
OUTPUT_PNG = Path(__file__).resolve().parent / "execution_time.png"
...
def main():
    ...
    ax.axhline(t_seq, linestyle="--", color="gray", label=f"Sequential baseline ({t_seq:.1f}s)")
