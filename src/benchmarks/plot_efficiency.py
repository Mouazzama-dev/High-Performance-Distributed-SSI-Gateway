#!/usr/bin/env python3
"""
Reads results.csv (produced by run_benchmarks.py) and plots Efficiency
(= Speedup / p) vs. number of processing elements for pure MPI, pure
multithreading, and hybrid configurations, alongside the ideal efficiency=1
line. Saves efficiency.png.
"""
import csv
...
OUTPUT_PNG = Path(__file__).resolve().parent / "efficiency.png"
...
def main():
    ...
    for mode, style in MODE_STYLE.items():
        ...
        ys = [(t_seq / r["time_sec"]) / r["total_pe"] for r in mode_rows]
    ...
    ax.set_title("Parallel Efficiency vs. Processing Elements")
